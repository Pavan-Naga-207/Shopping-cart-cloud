...
<div class="form-group">
					    ...
					    <textarea class="form-control unicase-form-control text-input"  name="billingaddress"><?php echo $row['billingAddress'];?></textarea>
					  </div>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>">
					  </div>
					  <div class="form-group">
